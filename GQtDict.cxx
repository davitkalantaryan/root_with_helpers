...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TQtMarker*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TQtMarker", ::TQtMarker::Class_Version(), "TQtMarker.h", 37,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TQMimeTypes*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TQMimeTypes", ::TQMimeTypes::Class_Version(), "TQMimeTypes.h", 68,
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtTimer*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtMarker*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtWidget*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtClientWidget*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtClientFilter*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQMimeTypes*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtBrush*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtApplication*)0x0)->GetClass(); }
   return fgIsA;
}
...
TClass *TGQt::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGQt*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TQtPadFont*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace {
  void TriggerDictionaryInitialization_GQtDict_Impl() {
...
"/usr/lib64/qt4/mkspecs/linux-g++",
"/usr/include/QtCore",
"/usr/include/QtGui",
"/usr/include",
"src",
"inc",
"/afs/ifh.de/group/pitz/data/ers/sys/Nitrogen/opt/root2/include",
".moc",
"/afs/ifh.de/group/pitz/data/ers/sys/Nitrogen/opt/root2/include",
"/afs/ifh.de/group/pitz/doocs/develop/kalantar/dev/root-with-helpers2/root/graf2d/qt/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(QTimer to awake the ROOT event loop from Qt event loop)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtTimer.h")))  TQtTimer;
class __attribute__((annotate(R"ATTRDUMP(Convert  ROOT TMarker objects on to QPointArray)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtMarker.h")))  TQtMarker;
class __attribute__((annotate(R"ATTRDUMP(QWidget to back ROOT TCanvas (Can be used with Qt designer))ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtWidget.h")))  TQtWidget;
class __attribute__((annotate(R"ATTRDUMP(QFrame implementation backing  ROOT TGWindow objects)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TGQt.h")))  TQtClientWidget;
class __attribute__((annotate(R"ATTRDUMP(Map Qt and ROOT event)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtClientFilter.h")))  TQtClientFilter;
class __attribute__((annotate(R"ATTRDUMP(Pool of mime type objects)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQMimeTypes.h")))  TQMimeTypes;
class __attribute__((annotate(R"ATTRDUMP(create QBrush object based on the ROOT "fill" attributes)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(create QBrush object based on the ROOT "fill" attributes)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtBrush.h")))  TQtBrush;
class __attribute__((annotate(R"ATTRDUMP(Instantiate the Qt system within ROOT environment)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtApplication.h")))  TQtApplication;
class __attribute__((annotate(R"ATTRDUMP(Interface to Qt GUI)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TGQt.h")))  TGQt;
class __attribute__((annotate("$clingAutoload$inc/TQtRootSlot.h")))  TQtRootSlot;
class __attribute__((annotate(R"ATTRDUMP(< Create Qt QFont object based on ROOT TAttText attributes)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$inc/TQtPadFont.h")))  TQtPadFont;
)DICTFWDDCLS";
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("GQtDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_GQtDict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_GQtDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_GQtDict() {
  TriggerDictionaryInitialization_GQtDict_Impl();
}
